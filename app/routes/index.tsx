      ...
      <section className="relative py-20">
        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="max-w-2xl mx-auto pt-20 mb-10 text-center">
            ...
            <div className="relative flex flex-wrap mt-10 mb-6">
              <input
                className="relative mb-2 md:mb-0 w-full py-4 pl-4 text-sm border rounded"
                type="text"
                readOnly
                value="https://api.sssapi.app/wAR1fWuTyRyQJxLPzpqQf"
              />
              <span className="absolute top-0 left-0 ml-4 -mt-2 px-1 inline-block bg-white text-gray-500 text-xs">
                kuso API
              </span>
        ...
        <div className="text-center block mt-4">
          <a
            className="py-4 px-6 inline-block text-sm text-white font-medium leading-normal bg-red-400 hover:bg-red-300 rounded transition duration-200"
            data-config-id="primary-action"
            href="https://docs.google.com/forms/d/e/1FAIpQLSdz5yYrR6vmUeUC_kUg7OmssOCVfxzsS3__GJ6gdWRrWsiL-w/viewform"
            target="_blank"
          >
            Add your "kuso" data.
          </a>
          <p className="text-xs text-gray-600 mt-2">Google Form に飛びます。</p>
        </div>
      </section>
      <section className="relative py-20">
        <img
        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl mx-auto mb-20 text-center">
            ...
            <h2 className="mt-8 mb-10 text-4xl font-semibold font-heading">
              Kuso API is soooo expensive!
              <br />
              But if you are a kuso professional, you can donate me :)
            </h2>
              ...
              <div className="pt-12 pb-8 px-8 border rounded-xl lg:text-center">
                ...
                <ul className="mb-6 text-left">
                  ...
                  <li className="flex items-center py-4 border-b">
                    ...
                    <p className="font-medium">Working materials</p>
                  </li>
                  <li className="flex items-center py-4 border-b">
                    <svg
                      className="mr-2"
                    ...
                    <p className="font-medium">100GB cloud spirit</p>
                  </li>
              ...
              <div className="pt-12 pb-8 px-8 bg-red-400 rounded-xl lg:text-center">
                ...
                <ul className="mb-6 text-left">
                  ...
                  <li className="flex items-center py-4 border-b border-red-400">
                    ...
                    <p className="font-medium text-white">
                      Complete documentation はもらえませんし、
                    </p>
                  </li>
                  <li className="flex items-center py-4 border-b border-red-400">
                    <svg
      ...
      <section className="relative py-20">
        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl mx-auto mb-20 text-center">
            ...
            <h2 className="mt-8 mb-10 text-4xl font-semibold font-heading">
              This API is created by using{" "}
              <a
                href="https://sssapi.app/"
                target="_blank"
                className="ml-1 bg-red-400  hover:bg-red-300"
              >
                SSSAPI
              </a>
              .
          ...
          <div className="">
            <p className="text-xs">
              このサイトはSSSAPIを利用しています。以下は、iframe で
